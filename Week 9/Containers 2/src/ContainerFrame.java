...
public class ContainerFrame extends JFrame {
	...
	private JList shipList = new JList();    //ΟΨΗ ΜΙΑΣ Λίστας - View
	...
	public ContainerFrame(ArrayList<Ship> someShips) {
		...
		DefaultListModel model = new DefaultListModel();  //ΜΟΝΤΕΛΟ - Model
		...
		shipList.setModel(model);   //Σύνδεσης όψης - μοντέλου
	...
	class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource().equals(createBulkButton)) {
				...
				//Πατήθηκε το πλήκτρο create Refr
